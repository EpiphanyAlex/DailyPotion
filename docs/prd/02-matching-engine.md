...
| 功能 | 消费的能力 |
|---|---|
| [Home Dashboard](04-home-dashboard.md) | Daily Pour hero（dailyPour）、Cabinet Snapshot 四卡（可调配方数、Missing Just One、Cabinet Completion）、Because You Have X（becauseYouHave） |
